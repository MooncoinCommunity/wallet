    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The mooncoin address to validate"},
                },
                RPCResult{
            "{\n"
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"getaddresstxids",
                "\nReturns the txids for an address(es).\n",
                {
                    {"Input params", RPCArg::Type::OBJ, RPCArg::Optional::NO, "Json object",
                        {
                            {"addresses", RPCArg::Type::ARR, RPCArg::Optional::NO, "The mooncoin addresses",
                                {
                                    {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "The mooncoin address"},
                                }
                            },
            ...
            "]\n"
                ...
                RPCExamples{
                    HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"]}") +
                    HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"], \"start\": 5000, \"end\": 5500}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"], \"start\": 5000, \"end\": 5500}")
                },
            }.ToString());
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
                ...
                RPCExamples{
                    HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"]}")
                },
            }.ToString());
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
                ...
                RPCExamples{
                    HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"]}")
                },
            }.ToString());
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
                ...
                RPCExamples{
                    HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"]}") +
                    HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"], \"chainInfo\": true}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"2D6CY2zmVvw6uDmbL6yc6GSX7F6ivzQuJA\"], \"chainInfo\": true}")
                },
            }.ToString());
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The mooncoin address to use for the signature."},
